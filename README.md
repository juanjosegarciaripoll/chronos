...
- Textual TUI for agenda, day, and multi-day grid views, with
  create/edit/trash/search/sync flows, click-and-drag creation with a live
  range preview, drag-to-reschedule, and a compact date/time editor.
