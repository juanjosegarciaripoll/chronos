...
class MirrorRepository(Protocol):
    ...
    ) -> Sequence[ComponentRef]: ...

    def read(self, ref: ComponentRef) -> bytes: ...

    def write(self, ref: ComponentRef, data: bytes) -> None: ...

    def delete(self, ref: ComponentRef) -> None: ...

    def move(self, source: ComponentRef, target: ComponentRef) -> None: ...
